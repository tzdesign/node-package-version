...
running command...
$ npv (--version)
node-package-version/0.0.5 darwin-x64 node-v16.20.2
$ npv --help [COMMAND]
USAGE
  $ npv COMMAND
...
...
_See code: [dist/commands/fix/index.ts](https://github.com/tzdesign/node-package-version/blob/v0.0.5/dist/commands/fix/index.ts)_
